...
public class SearchByDialogType extends JDialog implements ActionListener {
	...
	public SearchByDialogType() {

	}

	public void SearchByIdOrSurnameDialog(EmployeeDetails parent, String type) {
		searchType = type;
